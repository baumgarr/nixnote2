...
#define NOTE_TABLE_THUMBNAIL_POSITION 20
#define NOTE_TABLE_REMINDER_ORDER_POSITION 21
#define NOTE_TABLE_REMINDER_TIME_POSITION 22
#define NOTE_TABLE_REMINDER_TIME_DONE_POSITION 23
#define NOTE_TABLE_COLUMN_COUNT 24
