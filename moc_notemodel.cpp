...
**
** Created: Wed Jul 11 12:42:14 2012
...
static const char qt_meta_stringdata_NoteModel[] = {
    "NoteModel\0"
};

const QMetaObject NoteModel::staticMetaObject = {
    { &QSqlTableModel::staticMetaObject, qt_meta_stringdata_NoteModel,
      qt_meta_data_NoteModel, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NoteModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NoteModel))
